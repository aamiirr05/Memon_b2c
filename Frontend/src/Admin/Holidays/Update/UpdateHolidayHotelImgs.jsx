  ...
  const onFormSubmit = async () => {
    ...
    try {
      ...
      const res = await axiosInstance.put(
        `/admin/packages/update-holiday-package-hotel-image/${updateid}`,
        formData,
        {
  ...
  return (
    ...
    >
      ...
      <div className="w-full mx-auto flex flex-col md:flex-row flex-wrap items-center justify-center gap-10 mb-10">
        {extractedPackages?.hotel_images.map((images, i) => {
          return (
            <img
...
export default UpdateHolidayHotelImgs;
