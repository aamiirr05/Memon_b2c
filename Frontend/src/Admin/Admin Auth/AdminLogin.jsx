...
const AdminLogin = () => {
  ...
  const { login, isAdminLoggingIn } = useAdminAuthStore();
        ...
        <div className="w-11/12 md:w-2/3 rounded-xl lg:w-1/2 xl:w-1/3 bg-peach bg-opacity-60 m-2 text-darkgreen shadow-2xl">
          <form className="p-5" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="relative mt-10 flex flex-col gap-2">
              ...
              <span className="text-sm text-[#E63946]">{errors?.email?.message}</span>
            </div>
            ...
            <div className="relative mt-10 flex flex-col gap-2">
              ...
              <span className="text-sm text-[#E63946]">{errors?.password?.message}</span>
            </div>
