...
const EnquiryVisa = () => {
  ...
  const approvedEnquiry = visaEnquiry?.data?.data.filter((i) => {
    return i.status == 'Approved';
  });

  const pendingEnquiry = visaEnquiry?.data?.data.filter((i) => {
    return i.status == 'Pending';
  });
  const rejectedEnquiry = visaEnquiry?.data?.data.filter((i) => {
  ...
  const data = visaEnquiry.data?.data || [];
      ...
      >
        <div className="mt-5 relative grid grid-rows-2 gap-5">
          ...
          >
            ...
            <div className="py-2 px-2 col-span-2">Visa Country</div>
            <div className="py-2 px-2 col-span-3 ">Visa Type</div>
          ...
          <div className="rounded-xl flex flex-col gap-3 w-full  ">
            {visaEnquiry.data && !visaEnquiry?.data?.data.length == 0 ? (
                ...
                return (
                  ...
                  >
                    ...
                    <div className="py-2 px-2 col-span-2 flex flex-col gap-1 justify-start items-center">
                      <>
                        <span className="">{e.visa_country}</span>
                      </>
                    </div>
                    <div className="py-2 px-2 col-span-3 ">
                      <span>{e.visa_type}</span>
                    </div>
